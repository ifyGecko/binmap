...
# Fully static build. Requires libSDL2.a (and static versions of every SDL2
...
STATIC_CFLAGS = -Wall -Wextra -O2 -std=c11 \
                $(shell pkg-config --cflags --static sdl2 2>/dev/null)
STATIC_LDFLAGS = -static \
                 $(shell pkg-config --libs --static sdl2 2>/dev/null) -lm
